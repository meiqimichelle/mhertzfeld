---
title: Building Buildkite's first Ideal Customer Profile
layout: post-work
image:
 feature: buildkite-home_feature.png
 title: Fully dynamic pipelines with Bazel and Buildkite
 credit: Buildkite marketing team
 creditlink: https://buildkite.com/resources/blog/fully-dynamic-pipelines-with-bazel-and-buildkite/
 work: buildkite-components_work.svg
author: Michelle Hertzfeld
tags: [product marketing, research, buyer personas, target accounts]
categories: [work]
---
[Buildkite](https://buildkite.com/) is a fast-growing software delivery provider serving global leaders including Airbnb, Canva, Elastic, Lyft, Shopify, Slack, and Uber. However, in early 2024, it had a problem: it was still known as the “best-kept secret in CI/CD,” not exactly ideal for a growing company.<!--more-->
...
As part of the reorg, customer research moved into marketing, and I transitioned along with it. I began reporting to the new VP of Product Marketing, who tasked me with **developing Buildkite’s first [Ideal Customer Profile (ICP)](https://www.productmarketingalliance.com/how-to-determine-your-ideal-customer-profile/)**. This work would define Buildkite's **best-fit customers**, and serve as a strategic foundation for all our further messaging and positioning work.
...
- Our significant [company re-launch](https://buildkite.com/about/press/buildkite-launches-first-scale-out-delivery-platform/) in October 2024.
